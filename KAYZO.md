...
## Pricing integration plugin

| File                                            | Change                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `extensions/kayzo-pricing/openclaw.plugin.json` | New plugin manifest. Config schema: `licenseKey`, `supabaseUrl`, `supabaseAnonKey`.                                                                                                                                                                                                                                                                                                                                         |
| `extensions/kayzo-pricing/package.json`         | New workspace package. Runtime dep: `@sinclair/typebox` 0.34.49 (for tool parameter schemas).                                                                                                                                                                                                                                                                                                                               |
| `extensions/kayzo-pricing/api.ts`               | Local barrel re-exporting `definePluginEntry` and types from `openclaw/plugin-sdk/core`.                                                                                                                                                                                                                                                                                                                                    |
| `extensions/kayzo-pricing/index.ts`             | Plugin implementation: `gateway_start` (calls `get-integrations` edge function, caches credentials), `before_agent_start` (injects pricing context with store names + account numbers when configured), `registerTool("lookup_lowes_price")`, `registerTool("lookup_homedepot_price")` — both POST to vendor API with account number + store_zip passthrough, return `AgentToolResult` with formatted text + product array. |
| `extensions/kayzo-pricing/index.test.ts`        | TDD test suite (45 tests). Written before implementation.                                                                                                                                                                                                                                                                                                                                                                   |
| `scripts/provision-customer.sh`                 | Added `kayzo-pricing` plugin entry to kayzo.json template.                                                                                                                                                                                                                                                                                                                                                                  |
